package com.mandu.cms.user.footer.controller;
...
public class UserFooterController {
	...
	// 사용자 하단(푸터)
	@RequestMapping(value="{siteCode}/footer/view", method=RequestMethod.GET)
	private String footerView(
		...
		return "/cms/user/" + (siteCode != null && siteCode.equals("base") ? "base" : "site") + "/footer/userFooterView";
	}
